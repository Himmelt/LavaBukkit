...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo {
    ...
    public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String generatorOptions) {
        ...
        */
        ...
        WorldSettings worldsettings = new WorldSettings(seed, this.getGameType(), this.canStructuresSpawn(),
        ...
        for (int dim : dimIds) {
            ...
            if (dim == 0) {
                ISaveHandler idatamanager = new AnvilSaveHandler(server.getWorldContainer(), worldNameIn, true,
                        this.dataFixer);
                ...
                if (this.isDemo()) {
                    world = (WorldServer) (new WorldServerDemo(this, idatamanager, worlddata, dim, this.profiler))
                            .init();
                } else {
                    world = (WorldServer) (new WorldServer(this, idatamanager, worlddata, dim, this.profiler,
                            worldEnvironment, gen)).init();
                }
                ...
                if ((!newWorld.isDirectory()) && (oldWorld.isDirectory())) {
                    ...
                    if (newWorld.exists()) {
                        ...
                        if (oldWorld.renameTo(newWorld)) {
                            ...
                            try {
                                com.google.common.io.Files.copy(new File(new File(saveName), "level.dat"),
                                        new File(new File(name), "level.dat"));
                                org.apache.commons.io.FileUtils.copyDirectory(new File(new File(saveName), "data"),
                ...
                world = (WorldServer) new WorldServerMulti(this, idatamanager, dim, this.worldServerList.get(0),
                        this.profiler, worlddata, worldEnvironment, gen).init();
            }
