...
public class FMLTweaker implements ITweakerDebuggable {
    ...
    public void acceptOptions(List<String> args, File gameDir, File assetsDir, String profile) {
        if (DebuggableLaunch.blackboard == null) {
            DebuggableLaunch.blackboard = new HashMap<>();
        }
        this.gameDir = (gameDir == null ? new File(".") : gameDir);
        this.launchArgs = (Map<String, String>) DebuggableLaunch.blackboard.get("launchArgs");

        this.standaloneArgs = Lists.newArrayList();
        if (this.launchArgs == null) {
            this.launchArgs = Maps.newHashMap();
            DebuggableLaunch.blackboard.put("launchArgs", this.launchArgs);
        }
    ...
    public void injectCascadingTweak(String tweakClassName) {
        @SuppressWarnings("unchecked")
        List<String> tweakClasses = (List<String>) DebuggableLaunch.blackboard.get("TweakClasses");
