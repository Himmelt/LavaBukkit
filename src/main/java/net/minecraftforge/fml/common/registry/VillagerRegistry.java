...
public class VillagerRegistry
{
    ...
    public interface IVillageCreationHandler
    {
         ...
         * @param p5
         */
        Village buildComponent(PieceWeight villagePiece, StructureVillagePieces.Start startPiece, List<StructureComponent> pieces, Random random, int p1,
    ...
    public static class VillagerCareer
    {
        ...
        private VillagerCareer init(ITradeList[][] trades)
        {
