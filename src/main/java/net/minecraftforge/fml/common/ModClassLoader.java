...
public class ModClassLoader extends URLClassLoader {
    private static final List<String> STANDARD_LIBRARIES = ImmutableList.of("jinput.jar", "lwjgl.jar", "lwjgl_util.jar",
            "rt.jar");
    private DebuggableLaunchLoader mainClassLoader;
    private URLClassLoader fallbackClassLoader;
    private List<File> sources;

    public ModClassLoader(ClassLoader parent) {
        super(new URL[0], null);
        this.mainClassLoader = (DebuggableLaunchLoader) parent;
    ...
    public Class<?> loadClass(String name) throws ClassNotFoundException {
        return mainClassLoader == null ? fallbackClassLoader.loadClass(name) : mainClassLoader.loadClass(name);
    }
    ...
    public boolean isDefaultLibrary(File file) {
        ...
        String[] prefixes = { "launchwrapper-", "asm-all-", "akka-actor_2.11-", "config-", "scala-", "jopt-simple-",
                ...
                "jinput-", "jutils-", "gson-", "authlib-", "log4j-api-", "log4j-core-", "lwjgl-", "lwjgl_util-",
                "twitch-", "jline-", "jna-", "platform-", "oshi-core-", "netty-", "libraryjavasound-", "fastutil-" };
