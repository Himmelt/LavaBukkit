...
public class FMLSanityChecker implements IFMLCallHook {
    ...
    private static final String MCFINGERPRINT = "CD:99:95:96:56:F7:53:DC:28:D8:63:B4:67:69:F7:F8:FB:AE:FC:FC"
            .toLowerCase().replace(":", "");
    private DebuggableLaunchLoader cl;
            ...
            if (certificates != null) {
                ...
                for (Certificate cert : certificates) {
                    ...
                    if (fingerprint.equals(FMLFINGERPRINT)) {
                        ...
                        FMLLog.log.info("Found valid fingerprint for Minecraft Forge. Certificate fingerprint {}",
                                fingerprint);
                        goodFML = true;
                    } else {
                ...
                if (certificates != null) {
                    ...
                    for (Certificate cert : certificates) {
                        ...
                        if (fingerprint.equals(MCFINGERPRINT)) {
                            FMLLog.log.info("Found valid fingerprint for Minecraft. Certificate fingerprint {}",
                                    fingerprint);
                            goodMC = true;
                        }
                    }
    ...
    public void injectData(Map<String, Object> data) {
        ...
        cl = (DebuggableLaunchLoader) data.get("classLoader");
